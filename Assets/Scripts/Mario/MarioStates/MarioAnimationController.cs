...
public class MarioAnimationController : MonoBehaviour
{
    ...
    private IMarioContext _context;
    ...
    private void Awake()
    {
        ...
        _context = GetComponent<IMarioContext>();
        if (_context == null)
        {
        ...
        else
        {
            ...
            IMarioContext.OnEnterSmallMario += TriggerSmallMario;
            IMarioContext.OnEnterBigMario += TriggerBigMario;
            IMarioContext.OnEnterFireMario += TriggerFireMario;
        }
    }
