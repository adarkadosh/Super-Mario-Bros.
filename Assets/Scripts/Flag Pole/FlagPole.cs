...
namespace Flag_Pole
{
    ...
    {
        private static readonly int IsSlidingDownPole = Animator.StringToHash("IsSlidingDownPole");
        ...
        [SerializeField] private MarioMovementControl marioController; // Reference to Mario's controller
